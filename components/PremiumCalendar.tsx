        ...
        <View style={[styles.calendarCard, { backgroundColor: cardBg, borderColor }]}>
            ...
            <View style={styles.weekDays}>
                {['D', 'L', 'M', 'M', 'J', 'V', 'S'].map((d, i) => (
                    <Text key={`${d}-${i}`} style={[styles.weekDayText, { color: textSecondary }]}>
                        {d}
                    </Text>
                ))}
            </View>
                    ...
                    return (
                        ...
                        >
                            <Text style={[
                                ...
                                isToday && !isSelected && { color: '#8B5CF6', fontWeight: 'bold' }
                            ]}>
                                {d.day}
                            </Text>
                            {hasEvnt && (
                                <View style={[styles.eventDot, { backgroundColor: isSelected ? '#FFF' : '#8B5CF6' }]} />
                            )}
                        </Pressable>
                    );
                })}
