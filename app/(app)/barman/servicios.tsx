  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <PremiumHeader
        ...
        rightComponent={
          <Pressable
            onPress={() => router.replace("/(app)/barman/(tabs)")}
      ...
      <ServiciosModales
        ...
        onCloseEdit={() => dispatch({ type: 'SET_EDIT_MODAL', visible: false })}
        onSuccessEdit={() => {
          refreshTimers();
          fetchFinalizados();
        }}
        ...
        onCloseDetail={() => dispatch({ type: 'SET_DETAIL_MODAL', visible: false })}
        theme={theme}
      />
    </View>
  );
